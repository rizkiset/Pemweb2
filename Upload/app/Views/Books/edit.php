    ...
    <form action="/books/update/<?= $buku['id']; ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <div class="input-group mb-3">
                ...
                <label class="input-group-text custom-file-label" for="sampul">
                    <?= old('sampul') ? old('sampul') : ($buku['sampul'] ?? 'Pilih gambar...'); ?>
                </label>
            ...
            <img src="/img/<?= old('sampul') ? old('sampul') : ($buku['sampul'] ?? 'default.jpg'); ?>"
                class="img-thumbnail img-preview mt-2" style="width: 100px; height: 100px; object-fit: cover;">
        </div>
